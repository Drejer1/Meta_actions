...
;fill-shot_mcr_pour-shot-to-used-shaker remove ?h1
(:action dynamicmacro_pre_5 :parameters (?s - shot ?i - ingredient ?h2 - hand ?d - dispenser ?dx5 - shaker ?lx6 - level ?l1x7 - level)
:precondition (and (handempty ?h2)
(dispenses ?d ?i)
(empty ?s)
(clean ?s)
...
:effect (and (shaker-level ?dx5 ?l1x7)
(not (shaker-level ?dx5 ?lx6))
(used ?s ?i)
(not (contains ?s ?i))
(contains ?dx5 ?i)
