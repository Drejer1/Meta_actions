(define (domain barman)
 ...
 (:action dynamicmacro_pre_5
  :parameters ( ?s - shot ?i - ingredient ?h2 - hand ?d - dispenser ?dx5 - shaker ?lx6 - level ?l1x7 - level)
  :precondition (and (handempty ?h2) (dispenses ?d ?i) (empty ?s) (clean ?s) (unshaked ?dx5) (shaker-level ?dx5 ?lx6) (next ?lx6 ?l1x7))
  :effect (and (shaker-level ?dx5 ?l1x7) (not (shaker-level ?dx5 ?lx6)) (used ?s ?i) (not (contains ?s ?i)) (contains ?dx5 ?i) (not (clean ?s)) (increase (total-cost) 0)))
)
