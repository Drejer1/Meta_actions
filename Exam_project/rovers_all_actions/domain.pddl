...
;navigate_mcr_sample_soil remove ?sx3
(:action dynamicmacro_eff_4 :parameters (?x - rover ?y - waypoint ?z - waypoint)
...
;take_image_mcr_navigate_mcr_communicate_image_data remove ?p
(:action dynamicmacro_mod_5 :parameters (?r - rover ?o - objective ?i - camera ?m - mode ?lx3x6 - lander ?yx6x7 - waypoint)
:precondition (and (calibrated ?i ?r)
(on_board ?i ?r)
(equipped_for_imaging ?r)
(supports ?i ?m)
