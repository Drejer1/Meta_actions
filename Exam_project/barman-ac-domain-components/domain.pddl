(define (domain barman)
 ...
 (:action refill_shot
  :parameters ( ?s_0 - shot ?i - ingredient ?h1 - hand ?h2 - hand ?d - dispenser)
  :precondition (and (holding ?h1 ?s_0) (handempty ?h2) (dispenses ?d ?i) (empty ?s_0) (used ?s_0 ?i))
  :effect (and (not (empty ?s_0)) (contains ?s_0 ?i) (increase (total-cost) 10)))
 (:action empty_shot
  :parameters ( ?h - hand ?p - shot ?b - beverage)
  :precondition (and (holding ?h ?p) (contains ?p ?b))
  :effect (and (not (contains ?p ?b)) (empty ?p) (increase (total-cost) 1)))
 (:action clean_shot
  :parameters ( ?s_0 - shot ?b - beverage ?h1 - hand ?h2 - hand)
  :precondition (and (holding ?h1 ?s_0) (handempty ?h2) (empty ?s_0) (used ?s_0 ?b))
  :effect (and (not (used ?s_0 ?b)) (clean ?s_0) (increase (total-cost) 1)))
 ...
 (:action pour_shot_to_used_shaker
  :parameters ( ?s_0 - shot ?i - ingredient ?d_0 - shaker ?h1 - hand ?l - level ?l1 - level)
  :precondition (and (holding ?h1 ?s_0) (contains ?s_0 ?i) (unshaked ?d_0) (shaker-level ?d_0 ?l) (next ?l ?l1))
  :effect (and (not (contains ?s_0 ?i)) (contains ?d_0 ?i) (empty ?s_0) (not (shaker-level ?d_0 ?l)) (shaker-level ?d_0 ?l1) (increase (total-cost) 1)))
 (:action empty_shaker
 ...
 (:action dynamicmacro_eff_6
  :parameters ( ?s_0 - shot ?i - ingredient ?h1 - hand ?h2 - hand ?d - dispenser ?lx6 - level ?l1x7 - level)
  :precondition (and (holding ?h1 ?s_0) (handempty ?h2) (dispenses ?d ?i) (empty ?s_0) (clean ?s_0) (next ?lx6 ?l1x7))
  :effect (and (used ?s_0 ?i) (not (clean ?s_0)) (not (contains ?s_0 ?i)) (increase (total-cost) 0)))
 (:action dynamicmacro_pre_1
  :parameters ( ?h - hand ?c - container ?ix2 - ingredient ?h2x3 - hand)
  :precondition (and (ontable ?c) (handempty ?h) (handempty ?h2x3) (not (= ?h ?h2x3)) (empty ?c) (used ?c ?ix2))
 ...
 (:action dynamicmacro_pre_3
  :parameters ( ?s_0 - shot ?i - ingredient ?h1 - hand ?d - dispenser ?dx5 - shaker ?lx6 - level ?l1x7 - level)
  :precondition (and (holding ?h1 ?s_0) (dispenses ?d ?i) (empty ?s_0) (clean ?s_0) (unshaked ?dx5) (shaker-level ?dx5 ?lx6) (next ?lx6 ?l1x7))
  :effect (and (shaker-level ?dx5 ?l1x7) (not (shaker-level ?dx5 ?lx6)) (used ?s_0 ?i) (not (contains ?s_0 ?i)) (contains ?dx5 ?i) (not (clean ?s_0)) (increase (total-cost) 0)))
 (:action dynamicmacro_pre_4
  :parameters ( ?s_0 - shot ?i - ingredient ?h1 - hand ?h2 - hand ?dx5 - shaker ?lx6 - level ?l1x7 - level)
  :precondition (and (holding ?h1 ?s_0) (handempty ?h2) (empty ?s_0) (clean ?s_0) (unshaked ?dx5) (shaker-level ?dx5 ?lx6) (next ?lx6 ?l1x7))
  :effect (and (shaker-level ?dx5 ?l1x7) (not (shaker-level ?dx5 ?lx6)) (used ?s_0 ?i) (not (contains ?s_0 ?i)) (contains ?dx5 ?i) (not (clean ?s_0)) (increase (total-cost) 0)))
 (:action dynamicmacro_pre_5
  :parameters ( ?s_0 - shot ?i - ingredient ?h2 - hand ?d - dispenser ?dx5 - shaker ?lx6 - level ?l1x7 - level)
  :precondition (and (handempty ?h2) (dispenses ?d ?i) (empty ?s_0) (clean ?s_0) (unshaked ?dx5) (shaker-level ?dx5 ?lx6) (next ?lx6 ?l1x7))
  :effect (and (shaker-level ?dx5 ?l1x7) (not (shaker-level ?dx5 ?lx6)) (used ?s_0 ?i) (not (contains ?s_0 ?i)) (contains ?dx5 ?i) (not (clean ?s_0)) (increase (total-cost) 0)))
 (:action dynamicmacro_pre_6
  :parameters ( ?b_0 - cocktail ?d1 - ingredient ?d2 - ingredient ?s - shaker ?h1 - hand ?lx6 - level ?l1x7 - level)
  :precondition (and (holding ?h1 ?s) (contains ?s ?d1) (contains ?s ?d2) (cocktail-part1 ?b_0 ?d1) (cocktail-part2 ?b_0 ?d2) (unshaked ?s) (shaker-level ?s ?lx6) (shaker-empty-level ?s ?l1x7))
  :effect (and (empty ?s) (not (contains ?s ?d2)) (not (shaker-level ?s ?lx6)) (not (contains ?s ?b_0)) (not (contains ?s ?d1)) (shaker-level ?s ?l1x7) (not (shaked ?s)) (not (unshaked ?s)) (increase (total-cost) 0)))
 (:action dynamicmacro_pre_7
  :parameters ( ?b_0 - cocktail ?d1 - ingredient ?d2 - ingredient ?s - shaker ?h2 - hand ?lx6 - level ?l1x7 - level)
  :precondition (and (handempty ?h2) (contains ?s ?d1) (contains ?s ?d2) (cocktail-part1 ?b_0 ?d1) (cocktail-part2 ?b_0 ?d2) (unshaked ?s) (shaker-level ?s ?lx6) (shaker-empty-level ?s ?l1x7))
  :effect (and (empty ?s) (not (contains ?s ?d2)) (not (shaker-level ?s ?lx6)) (not (contains ?s ?b_0)) (not (contains ?s ?d1)) (shaker-level ?s ?l1x7) (not (shaked ?s)) (not (unshaked ?s)) (increase (total-cost) 0)))
)
